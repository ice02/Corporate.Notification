...
namespace Notification.AgentSmith.Manager
{
    /// <summary>
    /// 
    /// </summary>
    ...
    //            };
    //            DirectSchedulerFactory.Instance.CreateScheduler("NotificationScheduler", "AUTO", new DefaultThreadPool(), jobStore);
    //            scheduler = await SchedulerRepository.Instance.Lookup("NotificationScheduler");
    //        }
    //    }
